...
"""
Apply priority B algorithm with optimal priority factor 3.0 for known 100 future departures,to an instance
...
KNOWN = 100
PRIORITY_FACTOR = 3
SOLUTION_FILE = "../../data/paper/solutions/10-priority-b-pf-optimal-kn-{}-solution.json".format(KNOWN)
