...
# Problem settings.
# Use the optimal priority factor, wich wwe determined expiremently witin use-priority-a.py.
PRIORITY_FACTOR = 2.41
# Output file
SOLUTION_FILE = "../../data/paper/solutions/10-priority-a-pf-optimal-solution.json"
...
if PRIORITY_FACTOR is not None:
    solver.priority_factor = PRIORITY_FACTOR
    print("Using priority factor factor {}".format(PRIORITY_FACTOR))
else:
