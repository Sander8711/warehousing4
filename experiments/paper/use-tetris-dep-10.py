...
SOLUTION_FILE = "../../data/paper/solutions/10-tetris-dep-solution.json"

warehouse = small_problem.load()

print("Use Tetris algorithm with full decision costs (from and to station) and priority by departures.")

solution = tetris.solve(warehouse, costs_type=CostsType.DECISION, occ_priority=tetris.OccupationPriority.DEPARTURE)
