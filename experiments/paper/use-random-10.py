...
import random
from prp.solvers.simple import RandomSolver
import prp.recorder as recorder
import prp.utils as utils
import small_problem

# Set fixed random seed to make this experiment reproducible.
# The Random solver uses python's built-in random number generator.
random.seed(7)

# Output file
SOLUTION_FILE = "../../data/paper/solutions/10-random-place-solution.json"

warehouse = small_problem.load()

print("Use random-place algorithm with full costs (from and to station).")
